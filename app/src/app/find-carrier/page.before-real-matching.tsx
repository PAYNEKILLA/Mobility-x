...
export default async function FindCarrierPage({
  ...
  const pickup =
    params.pickup ?? "Makurdi";

  const destination =
    params.destination ?? "Abuja";

  const packageSize =
    params.packageSize ?? "medium";
                ...
                (
                  ...
                  >
                    ...
                    <div className="p-6 sm:p-7">
                      ...
                      <a
                        href={`/confirm-booking?deliveryId=delivery-demo&tripId=${encodeURIComponent(
                          trip.id,
                          ...
                          trip.destination.address,
                        )}&earnings=${estimatedEarnings}&currency=NGN&distanceKm=${result.detourDistanceKm}&score=${result.compatibilityScore}`}
